...
(() => {
    ...
    function step(startTime) {
      ...
      if (timeFromLastUpdate > timePerFrame) {
        ...
        $element.attr('src', imagePath + `/spacebugseq${frameNumber}.jpg`);
    ...
    $(document).ready(() => {
      for (var i = 1; i < totalFrames + 1; i++) {
        $('body').append(`<div id="preload-image-${i}" style="background-image: url('${imagePath}/spacebugseq${i}.jpg');"></div>`);
      }
    });
